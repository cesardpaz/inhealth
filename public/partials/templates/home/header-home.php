<section id="header-home" class="border-b-20p border-solid border-primary h-screen relative">

    <div class="absolute top-0 left-1/2 transform -translate-x-1/2 container w-1240p max-w-full mx-auto px-4 bg-primary py-4 items-center rounded-b-2xl z-10">
        <div class="flex justify-between items-center px-12">
            ...
            <div class="gap-4 text-white hidden lg:flex">
    ...
    <section id="my-slider" class="splide" aria-label="Slider Principal">
        <div class="splide__track">
            <ul class="splide__list">
                <li class="splide__slide fg1 flex items-end lg:items-center h-screen w-full">

                    <div class="container w-1240p max-w-full mx-auto px-4 mb-28 lg:mb-0">
                        <div class="text-white">
                            ...
                            <div class="mt-5">
                                <a target="_blank" href="<?php echo INHEALTH_DIR_URI . 'public/files/brochureh.pdf'; ?>" class="hidden lg:inline-block bg-secondary text-xl lg:text-2xl rounded-full px-6 py-3 avenir-demi">Quiero recibir información</a>
                                <a target="_blank" href="<?php echo INHEALTH_DIR_URI . 'public/files/brochurev.pdf'; ?>" class="inline-block lg:hidden bg-secondary text-xl lg:text-2xl rounded-full px-6 py-3 avenir-demi">Quiero recibir información</a>
                            </div>
                        </div>
                    </div>

                </li>
                <li class="splide__slide fg2 flex items-end lg:items-center h-screen w-full">

                    <div class="container w-1240p max-w-full mx-auto px-4 mb-28 lg:mb-0">
                        <div class="text-white">
                            <h2 class="text-6xl lg:text-8xl font-regular font-barlow">Atención temprana 2</h2>
                            <p class="text-2xl lg:text-3xl mt-5 avenir-italic">Para una sociedad en la que hablemos de convivencia.</p>
                            <div class="mt-5">
                                <a target="_blank" href="<?php echo INHEALTH_DIR_URI . 'public/files/brochureh.pdf'; ?>" class="hidden lg:inline-block bg-secondary text-xl lg:text-2xl rounded-full px-6 py-3 avenir-demi">Quiero recibir información</a>
                                <a target="_blank" href="<?php echo INHEALTH_DIR_URI . 'public/files/brochurev.pdf'; ?>" class="inline-block lg:hidden bg-secondary text-xl lg:text-2xl rounded-full px-6 py-3 avenir-demi">Quiero recibir información</a>
